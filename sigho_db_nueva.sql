...
CREATE TABLE IF NOT EXISTS `mydb`.`valor` (
  ...
  CONSTRAINT `fk_parametro_valor`
    ...
    REFERENCES `mydb`.`parametro` (`idparametro`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`disponiblidad`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`disponiblidad` (
...
-- -----------------------------------------------------
-- Table `mydb`.`ficha_grupo`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ficha_grupo` (
