	...
	if ($upfil){
        ...
        <br /><br /><br />
		  ...
		  while($i<$fin){
					...
					// Inserta PROGRAMAS
					$sql8="SELECT count(cod_programa) as cprg FROM programas WHERE cod_programa='".$datos[24]."'";
					$data8=$conexion->SelectDato($sql8);
					if($data8[0][0]==0){
						$sql9= "insert into programas (cod_programa, nom_programa, cod_nivel) values ('".$datos[24]."',
						'".$datos[26]."','".$datos[7]."')";
