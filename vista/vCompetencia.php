...
<script language="javascript">
    function Recargarcompetencia(value) {
        var parametros = {
            "valor": value
        };
        $.ajax({
            ...
            success: function (response) {
                $("#reloadcompetencia").html(response);
            }
        });
    }
</script>
...
<script language="javascript">
    function Recargarresultado(value) {
        var parametros = {
            "valor": value
        };
        $.ajax({
...
<div>
    ...
    <form name= "competencia" action="" method = "POST">
        ...
        <select class="form-control" id="programaid" name="programaid" required="required" onchange="javascript:Recargarcompetencia(this.value);">
        ...
        <div class="modal-content">
            ...
            <form name="form1" method="post" action="">
                <div class="modal-body" >
                    <div  align="left" id="reloadcompetencia">
                        <select name="idcompetencia" id="id_estado" onchange="javascript:Recargarresultado(this.value);">
                            <option value>Seleccione un programa</option>
                        </select>
                    </div>  

                    <div  align="left" id="reloadresultado">
        ...
        <table class="table table-bordered table-hover table-striped">
            ...
            for ($i = 0; $i < count($dat); $i++) {
                ...
                <tr>
                    ...
                    <td align = "center"><?php if ($dat[$i]['calificado'] == 1) echo "<img src='image/activa.png'>";
            else echo "" ?></td>
                    <td align = "center"><?php if ($dat[$i]['calificado'] == 0) echo "<img src='image/activa.png'>";
            else echo "" ?></td>
